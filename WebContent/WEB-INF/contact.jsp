...
%>
      ...
      <form method="post" class="container mb-5" style="max-width: 1000px; margin-top:100px;">
         <center><h4>사용문의나 불편하신 부분, 궁금한 사항을 남겨주세요.</h4></center>
         <center>문의주신 내용은 <strong>마이페이지 '나의 문의내역'</strong>에서 확인 가능합니다.</center>
      </form>
      <section id="contact">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 mr-auto text-center">
                        ...
                        <a class="d-block" href="mailto:contact@yourwebsite.com">rueun0302@gmail.com</a>
                        <br/><br/>
                    </div>
                </div>
            </div>
        </section>
        <form form method="post" action="./contactAction.jsp" class="container mb-5" style="max-width: 2000px; background:#FFD542; padding-top:50px; padding-bottom:30px;">
      	<div class="form-group">
            <center>
            <input type="text" name="questiontitle" class="form-control" placeholder="제목" style ="width:500px">
            <input type="text" name="questioncontent" class="form-control" placeholder="문의내용" style ="width:500px; height:100px; margin-top:8px; margin-bottom:10px;">
            <button type="submit" class="btn btn-dark" style = "width: 100px;">문의하기</button>
            </center>
         </div>
      	</form><br><br>
