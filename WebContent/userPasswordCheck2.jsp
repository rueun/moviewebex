...
%>
      ...
      <br><br>
         ...
         <hr><br>
         <input type="button" onclick="location.href='userPasswordCheck.jsp'" class="btn btn-defalut" style = "width: 200px; font-family:'ELAND_Choice_M'" value="개인정보수정">
         ...
         <input type="button" onclick="location.href='userPasswordCheck2.jsp'" class="btn btn-dark" style = "width: 200px; font-family:'ELAND_Choice_M'" value="회원탈퇴">
         <hr style ="margin:0px">
      </form>
      
 	  <section class="container mb-5" style="max-width: 300px;">
	      <form method="post" action="./userPasswordCheckAction2.jsp">
	         <br>
	         ...
	         <div class="col text-center">
	         	<button type="submit" class="btn btn-primary" style = "width: 200px; font-family:'SEBANG_Gothic_Bold'">탈퇴하기</button>
	         </div>
	      </form>   
      </section>
