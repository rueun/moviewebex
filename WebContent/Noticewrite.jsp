...
%>
      ...
      <br><br><br>
         <h1 style="font-family:'font'">공지사항 작성</h1>
         <strong style="color:orange; font-family: 'gmarket'">'MOVIE WORLD'</strong><strong style="font-family:'gmarket'"> 사용자에게 알리는 공지사항을 작성해주세요.</strong>
         <hr>
      </form>
      <section class="container mb-5" style="max-width: 1000px;">
	      <form method="post" action="NoticewriteAction.jsp">
	         ...
	         <div class="col text-center">
	         	<a href="Notice.jsp" class="btn btn-dark" style="font-family:'SEBANG_Gothic_Bold'">취소</a>
				<input type="submit" class="btn btn-primary" value="작성하기" style="font-family:'SEBANG_Gothic_Bold'">
	         </div>
	      </form>
      </section>
