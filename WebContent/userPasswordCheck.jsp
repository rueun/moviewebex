...
%>
      ...
      <br><br>
         ...
         <hr><br>
         <input type="button" onclick="location.href='userPasswordCheck.jsp'" class="btn btn-dark" style = "width: 200px; font-family:'ELAND_Choice_M'" value="개인정보수정">
         <input type="button" onclick="location.href='userQuestion.jsp'" class="btn btn-defalut" style = "width: 200px; font-family:'ELAND_Choice_M'" value="나의 문의내역">
 	  ...
 	  <section class="container mb-5" style="max-width: 300px;">
	      <form method="post" action="./userPasswordCheckAction.jsp">
	         <br>
	         <center><img src="assets/img/logo.JPG" style="width:150px"></center>
	         <center><p style="font-family:'ELAND_Choice_M'">비밀번호를 입력해주세요.</p></center>
	         <div class="form-group">
	            <input type="password" name="userPassword" class="form-control" placeholder="Password" style="font-family:'ELAND_Choice_M'">            
	         </div>
	         <br><br><br>
	         <div class="col text-center">
	         	<button type="submit" class="btn btn-primary" style = "width: 200px; font-family:'SEBANG_Gothic_Bold'">개인정보수정</button>
	         </div>
	      </form>   
      </section>
