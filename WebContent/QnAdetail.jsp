...
%>
      ...
      <header class="loginout">
      	...
      	<form method="post" action="QnAAction.jsp?qnaID=<%= qnaID %>" class="container mb-5" style="max-width: 1100px; margin-top:100px;">
         <h1 style="font-family:'font'">고객센터</h1>
       	  <p><strong style="font-family:'gmarket'">고객 문의 사항에 대해 답변해주세요.</strong></p>
       	  <hr>
	         ...
	         <div class="contaioner" style="margin-right:10px; margin-left:10px;">
	         	<div class="row">
		      	...
		      	<div class="form-group">
		            <textarea class="form-control" placeholder="답변내용" name="qnaAnswer" maxlength="2048" style="height:120px; font-family:'ELAND_Choice_M'"></textarea><br>
		            <input type="submit" class="btn btn-primary" value="답변등록" style="font-family:'SEBANG_Gothic_Bold'">
		        </div>
       	  	 <%}%>
       	  	 <div class="col text-center">
       	  		<input type="button" onclick="location.href='QnA.jsp'" class="btn btn-primary" style = "width: 60px; font-family:'SEBANG_Gothic_Bold'" value="목록">
       	  	 </div>
      	</form>
